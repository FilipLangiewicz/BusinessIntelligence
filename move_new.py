...
INPUT_DIR = r"D:\STUDIA\Semestr 6\Hurtownie danych i systemy Business Intelligence\Laboratoria\Projekt\BusinessIntelligence\airbnb_data\NEW"
OUTPUT_DIR = r"D:\STUDIA\Semestr 6\Hurtownie danych i systemy Business Intelligence\Laboratoria\Projekt\BusinessIntelligence\airbnb_data\DB"

os.makedirs(OUTPUT_DIR, exist_ok=True)

# Ustawienie logowania do pliku
today_str = datetime.today().strftime('%Y%m%d%H%M%S')
log_path = fr"D:\STUDIA\Semestr 6\Hurtownie danych i systemy Business Intelligence\Laboratoria\Projekt\BusinessIntelligence\logs\4 move_new\move_new_{today_str}.txt"
